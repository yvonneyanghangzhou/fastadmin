<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"F:\2_install_path\wamp64\www\FastAdmin\public/../application/admin\view\exam\project\add.html";i:1598930167;s:81:"F:\2_install_path\wamp64\www\FastAdmin\application\admin\view\layout\default.html";i:1588765312;s:78:"F:\2_install_path\wamp64\www\FastAdmin\application\admin\view\common\meta.html";i:1588765312;s:80:"F:\2_install_path\wamp64\www\FastAdmin\application\admin\view\common\script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-org_id" data-rule="required" data-source="base_org/index" class="form-control selectpage" name="row[org_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Duration'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-duration" class="form-control" name="row[duration]" type="number" value="90">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-pass_line" class="form-control" name="row[pass_line]" type="number" value="90">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-start_date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[start_date]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Close_date'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-close_date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[close_date]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-allow_mock" class="form-control selectpicker" name="row[allow_mock]">
                <?php if(is_array($allowMockList) || $allowMockList instanceof \think\Collection || $allowMockList instanceof \think\Paginator): if( count($allowMockList)==0 ) : echo "" ;else: foreach($allowMockList as $key=>$vo): ?>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-mock_start_date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[mock_start_date]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Mock_close_date'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-mock_close_date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[mock_close_date]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-enable_commitment" class="form-control selectpicker" name="row[enable_commitment]">
                <?php if(is_array($enableCommitmentList) || $enableCommitmentList instanceof \think\Collection || $enableCommitmentList instanceof \think\Paginator): if( count($enableCommitmentList)==0 ) : echo "" ;else: foreach($enableCommitmentList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"2"))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-allow_print_commitment" class="form-control selectpicker" name="row[allow_print_commitment]">
                <?php if(is_array($allowPrintCommitmentList) || $allowPrintCommitmentList instanceof \think\Collection || $allowPrintCommitmentList instanceof \think\Paginator): if( count($allowPrintCommitmentList)==0 ) : echo "" ;else: foreach($allowPrintCommitmentList as $key=>$vo): ?>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-allow_print_certificate" class="form-control selectpicker" name="row[allow_print_certificate]">
                <?php if(is_array($allowPrintCertificateList) || $allowPrintCertificateList instanceof \think\Collection || $allowPrintCertificateList instanceof \think\Paginator): if( count($allowPrintCertificateList)==0 ) : echo "" ;else: foreach($allowPrintCertificateList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"1"))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
