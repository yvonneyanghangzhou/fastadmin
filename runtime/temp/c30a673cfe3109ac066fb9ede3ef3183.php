<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:95:"F:\2_install_path\wamp64\www\FastAdmin\public/../application/admin\view\exam\library\index.html";i:1600133158;s:81:"F:\2_install_path\wamp64\www\FastAdmin\application\admin\view\layout\default.html";i:1588765312;s:78:"F:\2_install_path\wamp64\www\FastAdmin\application\admin\view\common\meta.html";i:1588765312;s:80:"F:\2_install_path\wamp64\www\FastAdmin\application\admin\view\common\script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a href="javascript:;"
                            class="btn btn-success btn-add <?php echo $auth->check('exam/library/add')?'':'hide'; ?>"
                            data-area='["100%","100%"]'
                            title="<?php echo __('Add'); ?>"><i class="fa fa-plus"></i> <?php echo __('Add'); ?></a>
                        <a href="javascript:;"
                            class="btn btn-success btn-edit btn-disabled disabled <?php echo $auth->check('exam/library/edit')?'':'hide'; ?>"
                            data-area='["100%","100%"]'
                            title="<?php echo __('Edit'); ?>"><i class="fa fa-pencil"></i> <?php echo __('Edit'); ?></a>
                        <a href="javascript:;"
                            class="btn btn-danger btn-del btn-disabled disabled <?php echo $auth->check('exam/library/del')?'':'hide'; ?>"
                            title="<?php echo __('Delete'); ?>"><i class="fa fa-trash"></i> <?php echo __('Delete'); ?></a>
                        <a href="javascript:;"
                            class="btn btn-danger btn-import <?php echo $auth->check('exam/library/import')?'':'hide'; ?>"
                        ...
                        <div class="dropdown btn-group <?php echo $auth->check('exam/library/multi')?'':'hide'; ?>">
                        ...
                        <a class="btn btn-success btn-recyclebin btn-dialog <?php echo $auth->check('exam/library/recyclebin')?'':'hide'; ?>"
                            href="exam/library/recyclebin" title="<?php echo __('Recycle bin'); ?>"><i class="fa fa-recycle"></i>
                            <?php echo __('Recycle bin'); ?></a>
                    </div>
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                        data-operate-edit="<?php echo $auth->check('exam/library/edit'); ?>"
                        data-operate-del="<?php echo $auth->check('exam/library/del'); ?>" width="100%">
                    </table>
                </div>
            </div>
